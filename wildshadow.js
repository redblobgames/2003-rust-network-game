...
var oryx_env = new Spritesheet();
var oryx_obj = new Spritesheet();
var oryx_char = new Spritesheet();
...
const tileTypes =
    [
        ...
        ["Floor", 0xd9dcf3, true, oryx_env, 0x04, 'color', "hsla(240,10%,60%,0.5)"],
        ["Path", 0xb4b5bc, true, oryx_env, 0x60, 'color', "hsla(240,10%,60%,0.5)"],
        ["Water", 0x5278c5, true, oryx_env, 0xbc],
        ["Fountain", 0x2b4a8b, true, 'tile', 'Water', oryx_obj, 0x4f],
        ["Grass", 0x35863d, true, oryx_env, 0x48],
        ["Bench", 0x6b6b6b, true, oryx_env, 0x0c, 'color', "hsla(240,20%,70%,0.2)"],
        ["Tree", 0x184a1d, false, 'tile', 'Grass', oryx_env, 0x4d],
        ["Rock", 0x3e3e3e, true, oryx_env, 0x62],
        ["Gravestone", 0x00ff00, true, 'tile', 'Floor', oryx_obj, 0x13],
        ["Portal", 0xff0000, true, 'tile', 'Floor', oryx_env, 0x7c],
        ["Chicken", 0xffdcf3, true, 'tile', 'Floor', oryx_obj, 0x1d],
        ["Key", 0xd9fff3, true, 'tile', 'Floor', oryx_obj, 0x22],
        ["Bag", 0xc6b1ff, true, 'tile', 'Floor', oryx_obj, 0x08],
        ["Skull", 0xb1daff, true, 'tile', 'Floor', oryx_obj, 0x11],
        ["Cross", 0xfcffb1, true, 'tile', 'Floor', oryx_obj, 0x14],
        ["Sheep", 0xf2f2f2, false, 'tile', 'Grass', oryx_char, 0xd2],
        ["Money", 0x00af00, true, 'tile', 'Floor', oryx_obj, 0x00],
        ["Statue", 0x999999, false, 'tile', 'Floor', oryx_char, 0xa1],
        ["Flower_P", 0xff26db, true, 'tile', 'Grass', oryx_env, 0x6f],
        ["Flower_E", 0xd2ff1f, true, 'tile', 'Grass', oryx_env, 0x6e],
        // NOTE: last item is special, used for AMA markers. 0x8d is yoda, 0xc7 is a monkey, 0xb5 is an eye
        ["Marker", -1, true, 'tile', 'Grass', oryx_char, 0xb5],
    ];
...
function loadMapData(callback) {
    ...
    loadImage("assets/nexus-init.png", (image) => {
...
function drawMap() {
    if (oryx_char.image == null || oryx_env.image == null || oryx_obj.image == null || map == null) return;
...
oryx_obj.loadImage("assets/lofi_obj_a.png", drawMap);
oryx_char.loadImage("assets/lofi_char_a.png", drawMap);
